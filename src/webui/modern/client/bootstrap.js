...
const I = {
  ...
  actionResetCount: ${tj("action.reset_count")},
  actionDiscard: ${tj("action.discard")},
  ...
  fieldCustomPersonaEnabled: ${tj("field.custom_persona_enabled")},
  fieldCustomPersona: ${tj("field.custom_persona")},
  ...
  fieldGlobalPersonaMode: ${tj("field.global_persona_mode")},
  fieldGlobalPersonaUserId: ${tj("field.global_persona_user_id")},
  ...
  globalPersonaOn: ${tj("chats.global_persona_on")},
  globalPersonaOff: ${tj("chats.global_persona_off")},
  globalPersonaQuota: ${tj("chats.global_persona_quota")},
  globalPersonaModeSingle: ${tj("chats.global_persona_mode_single")},
  globalPersonaModeSequential: ${tj("chats.global_persona_mode_sequential")},
  globalPersonaModeRandom: ${tj("chats.global_persona_mode_random")},
  globalPersonaQueue: ${tj("chats.global_persona_queue")},
  globalPersonaNext: ${tj("chats.global_persona_next")},
  ...
  usersPersonaOn: ${tj("users.persona_on")},
  usersPersonaOff: ${tj("users.persona_off")},
  usersPersonaSaved: ${tj("users.persona_saved")},
  usersPersonaEmpty: ${tj("users.persona_empty")},
  usersPersonaPreview: ${tj("users.persona_preview")},
  usersPersonaCount: ${tj("users.persona_count")},
  usersUnsaved: ${tj("users.unsaved")},
  usersSaved: ${tj("users.saved")},
